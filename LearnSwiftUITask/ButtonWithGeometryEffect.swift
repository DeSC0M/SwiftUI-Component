//
//  ButtonWithGeometryEffect.swift
//  LearnSwiftUITask
//
//  Created by Pavel Murzinov on 02.09.2020.
//

import SwiftUI

struct ButtonWithGeometryEffect: View {
    @State var of: CGFloat = 0
    @State var skw: CGFloat = 0
...
struct ButtonWithGeometryEffect_Previews: PreviewProvider {
    static var previews: some View {
        ButtonWithGeometryEffect()
    }
}
